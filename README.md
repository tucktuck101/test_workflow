...
3) CI: `.github/workflows/ci.yml` runs pre-commit, quality gates via `ci/run_quality_gates.sh` (auto-detects Node/Python projects). Update scripts/tests as code lands. Coverage uses pytest-cov; add mypy/tsc scripts as scaffolds arrive.
